...
class BaseMetric(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Metric']] = 'Metric'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.MetricActions[_PrismaModelT]':
        from .client import get_client

        return actions.MetricActions[_PrismaModelT](client or get_client(), cls)
