...
SCHEMA_PATH = Path('C:/Users/Admin/Documents/aol-backend/prisma/schema.prisma')
...
class Prisma(AsyncBasePrisma):
    ...
    metric: 'actions.MetricActions[models.Metric]'
    ...
    def __init__(
        ...
        *,
        ...
        self.metric = actions.MetricActions[models.Metric](self, models.Metric)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'C:/Users/Admin/Documents/aol-backend/prisma/schema.prisma',
        }
...
class Batch:
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.metric = MetricBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class MetricBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

    def create(
        self,
        data: types.MetricCreateInput,
        include: Optional[types.MetricInclude] = None
    ) -> None:
        self._batcher._add(
            method='create',
            model=models.Metric,
    ...
    def create_many(
        self,
        data: List[types.MetricCreateWithoutRelationsInput],
        *,
        skip_duplicates: Optional[bool] = None,
    ) -> None:
        if skip_duplicates and self._batcher._active_provider in CREATE_MANY_SKIP_DUPLICATES_UNSUPPORTED:
    ...
    def delete(
        self,
        where: types.MetricWhereUniqueInput,
        include: Optional[types.MetricInclude] = None,
    ) -> None:
        self._batcher._add(
            method='delete',
    ...
    def update_many(
        self,
        data: types.MetricUpdateManyMutationInput,
        where: types.MetricWhereInput,
    ) -> None:
        self._batcher._add(
            method='update_many',
            model=models.Metric,
    ...
    def delete_many(
        self,
        where: Optional[types.MetricWhereInput] = None,
    ) -> None:
        self._batcher._add(
            method='delete_many',
            model=models.Metric,
